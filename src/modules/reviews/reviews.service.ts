...
export class ReviewsService implements IReviewsService {
    ...
    async createReview({ description, starCount, profileId }: CreateReviewDto, reviewerProfileId: number): Promise<ReviewWithRelatedTable> {
    ...
    async findAllReviews({ profileId, limit, offset }: FilterReviewDto): Promise<[ ReviewWithRelatedTable[], number ]> {
    ...
    async updateReview(id: number, { description, starCount }: UpdateReviewDto, reviewerProfileId: number): Promise<ReviewWithRelatedTable> {
    ...
    async checkAccess(reviewerProfileId: number, id: number): Promise<void> {
        ...
        const review: { reviewerProfileId: number } = await this.prisma.review.findFirstOrThrow({
            where: {
                id
            },
            select: {
