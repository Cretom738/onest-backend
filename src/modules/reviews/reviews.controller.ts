...
export class ReviewsController {
  ...
  async createReview(
    ...
    @UserInfo() { profileId }: IJwtPayload,
  ): Promise<ReviewDto> {
    const review: ReviewWithRelatedTable = await this.service.createReview(
      data,
      profileId,
    );
  ...
  async findAllReviews(
    @Query() filterData: FilterReviewDto,
  ...
  async findReviewById(
    ...
    const review: ReviewWithRelatedTable =
      await this.service.findReviewById(id);
  ...
  async updateReview(
    ...
    const review: ReviewWithRelatedTable = await this.service.updateReview(
      id,
      data,
      profileId,
    );
