...
export class SubCategoriesController {
  ...
  async createSubCategory(
    ...
    const subCategory: SubCategory = await this.service.createSubCategory(
      categoryId,
      data,
    );
  ...
  async findSubCategoriesByCategoryId(
    ...
    const subCategories: SubCategory[] =
      await this.service.findSubCategoriesByCategoryId(categoryId);
  ...
  async findSubCategoryById(
    ...
    const subCategory: SubCategory =
      await this.service.findSubCategoryById(subCategoryId);
  ...
  async updateSubCategory(
    ...
    const subCategory: SubCategory = await this.service.updateSubCategory(
      categoryId,
      subCategoryId,
      data,
    );
